      ...
      jp: {
        translation: {
          ...
          compare: {
            ...
            cancel: "戻る",
            description:
              "以下の選択肢から、比較したい結果を二つ選んでください。二つの結果の積み上げ棒グラフが作成されます。",
            compare: "比較する",
          },
          feed: {
            posts: "投稿数",
          ...
          group: {
            ...
            groupCreateDescription:
              "グループに参加した人だけが投票を見ることができ、グループ内だけでの投票が出来るようになります。以下の招待リンクをコピーして、友達を誘ってみましょう！",
            ...
            createGroup: "グループ作成",
            createGroupDesc:
              "グループを作成すると、グループに参加した人だけが閲覧・投票出来る機能が利用できます。グループを作成すると招待リンクが発行され、メンバーを招待することが可能になります。招待リンクは、グループ一覧ページからも確認できます。",
            create: "作成",
            joined: "参加しました",
          ...
          alert: {
            outside:
              "You are accessing Hearvo from outside Japan. Some actions are limited. Learn more.",
          },
          pollRecord: {
            votingLength: "投票期間",
            rePoll: "再投票",
          ...
          twitterInvite: {
            ...
            detailText:
              "あなたはこれについてどう思いますか？意見・経験を聞かせてください！",
      ...
      us: {
        translation: {
          ...
          compare: {
            ...
            cancel: "Cancel",
            description:
              "Plot a stacked bar chart of the results. Select two results to compare. ",
            compare: "Compare",
          },
          feed: {
            posts: "Post",
          ...
          newPost: {
            ...
            topic: "Topic",
            topicDescription:
              "Enter at least one topic, separate topics with a comma",
          ...
          group: {
            ...
            createGroupDesc:
              "Group feature allows you to hear specific people's opinion in the group. Only people in the group can see the posts. You can invite them by the invite link.",
            create: "Create",
            joined: "Joined",
          ...
          eachPost: {
            ...
            tellUsDetail:
              "Please let us know the details of the problem regarding this post.",
          ...
          tos: {
            sorry:
              "An English version of Terms of Service and Privacy Policy is currently unavailable. Please check a Japanese version. Sorry for inconvenience.",
          },
          privacy: {
            sorry:
              "An English version of Terms of Service and Privacy Policy is currently unavailable. Please check a Japanese version. Sorry for inconvenience.",
          ...
          alert: {
            outside:
              "You are accessing Hearvo from outside the United States. Some actions are limited. Learn more.",
          },
          pollRecord: {
