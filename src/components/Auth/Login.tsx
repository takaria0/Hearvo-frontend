  ...
  submit(e: any) {
    ...
    axios
      .post(
        ...
        { headers: { Country: process.env.REACT_APP_COUNTRY } }
      )
      .then((res: any) => {
        ...
        <div className={styles.body_inside}>
          ...
          <form onSubmit={(e) => this.submit(e)}>
            ...
            <div style={{ fontSize: 14, marginBottom: 10 }}>
              {i18n.t("login.confirmText1")}
              <br></br>
              <Link to="/tos" target="_blank">
                {i18n.t("login.confirmText2")}
              </Link>
              {i18n.t("login.confirmText3")}
              <Link to="/privacy" target="_blank">
                {i18n.t("login.confirmText4")}
              </Link>
              {i18n.t("login.confirmText5")}
              <br></br>
            </div>
