  ...
  return (
    <Dialog open={isOpen}>
      ...
      <div style={{ margin: "10px", padding: 30 }}>
        <h1>
          {i18n.t("group.groupCreateTitle1")}
          {groupName}
          {i18n.t("group.groupCreateTitle2")}
        </h1>
        {i18n.t("group.groupCreateDescription")}
        <div style={{ marginTop: 10, wordWrap: "break-word" }}>
          {" "}
          {groupLink}
          <div>
            <button
              style={{ marginTop: 10, textAlign: "center" }}
              onClick={(e) => copy(e, groupLink)}
            >
...
const GroupCreate = (props: GroupCreateProps) => {
  ...
  const submit = (e: any) => {
    ...
    axios
      .post("/groups", { title: groupName }, options)
      .then((res: any) => {
