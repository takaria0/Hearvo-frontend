            ...
            <div>
              <span>
                <Link
                  ...
                  to={`/topic?tp=${topic.topic}`}
                >
                  {topic.topic}
                </Link>
              </span>
              <span style={{ textAlign: "right", float: "right" }}>
                <TopicFollowButtonLoaded
                  topicWord={topic.topic}
                  isFollowed={true}
                ></TopicFollowButtonLoaded>
              </span>
    ...
    <div>
      ...
      >
        <span style={{ backgroundColor: "white" }}>
          <Link
            style={voteRecordStyle}
            to={"/profile/" + keywordArray[2] + "/voted"}
          >
            {i18n.t("profile.voteRecord")}
          </Link>
        </span>
        &nbsp;
        <span>
          <Link
            style={myPostsStyle}
            to={"/profile/" + keywordArray[2] + "/myposts"}
          >
            {i18n.t("profile.myPost")}
          </Link>
        </span>
      </div>
