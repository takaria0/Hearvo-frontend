...
const AttributePlotPie = (props: AttributePlotPiePlops) => {
  ...
  const genderData = [
    {
      id: i18n.t("eachPost.male"),
      value: props.genderDist.male,
      color: "hsla(220, 64%, 50%, 1)",
    },
    {
      id: i18n.t("eachPost.female"),
      value: props.genderDist.female,
      color: "hsla(0, 56%, 50%, 1)",
    },
    {
      id: i18n.t("eachPost.others"),
      value: props.genderDist.others,
      color: "hsla(114, 100%, 23%, 1)",
    },
  ];
