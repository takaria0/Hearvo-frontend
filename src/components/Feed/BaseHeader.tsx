    ...
    return (
      <div className={styles.mini_header}>
        <div
          ...
          onClick={(e) => this.editHandle(e, true)}
        >
          <input
            placeholder={i18n.t("newPost.create")}
            type="text"
            id="form"
          ></input>
        </div>
        <div className={styles.mini_header_inside}>
          ...
          {window.location.pathname.split("/")[1] === "popular" ? (
            <b>
              ...
              >
                <MenuItem onClick={(e) => this.handleClose(e, "now")}>
                  {i18n.t("feed.now")}
                </MenuItem>
                <MenuItem onClick={(e) => this.handleClose(e, "today")}>
                  {i18n.t("feed.today")}
                </MenuItem>
                <MenuItem onClick={(e) => this.handleClose(e, "week")}>
                  {i18n.t("feed.thisWeek")}
                </MenuItem>
                <MenuItem onClick={(e) => this.handleClose(e, "month")}>
                  {i18n.t("feed.thisMonth")}
                </MenuItem>
              </Menu>
            </b>
          ) : (
    ...
    return (
      <div>
        ...
        <PostContent
          ...
          editParentHandle={this.editHandle}
        ></PostContent>
      </div>
    );
  }
