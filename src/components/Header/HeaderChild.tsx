  ...
  handleClose = (e: any, val: any) => {
    ...
    if (val === "/login") {
      ...
      if (url[1] === "") {
        ...
        this.props.history.push(
          `${val}` + "?destination=" + url[1] + "&value=" + url[2]
        );
      } else {
        this.props.history.push(`${val}`);
      }
      ...
      <b>
        {
          this.state.isLogin ? (
            <b>
              ...
              >
                <button
                  style={inlineStyles.profileSection}
                  onClick={(e) =>
                    this.handleClose(
                      e,
                      "/profile/" + this.state.user.name + "/myposts"
                    )
                  }
                >
                  <div style={inlineStyles.realName}>
                    {this.state.user.first_name} {this.state.user.middle_name}{" "}
                    {this.state.user.last_name}
                  </div>
                  <div style={inlineStyles.profileName}>
                ...
                <MenuItem onClick={(e) => this.handleClose(e, "/tos")}>
                  <DescriptionIcon />
                  &nbsp;{i18n.t("settingBar.tos")}
                </MenuItem>
                <MenuItem onClick={(e) => this.handleClose(e, "/privacy")}>
                  <AssignmentIndIcon />
                  &nbsp;{i18n.t("settingBar.privacy")}
                </MenuItem>
                {/* <MenuItem onClick={e => this.handleClose(e, "/settings")}><SettingsIcon />&nbsp;{i18n.t('settingBar.settings')}</MenuItem> */}
                <MenuItem onClick={(e) => this.handleClose(e, "/login")}>
                  <ExitToAppIcon />
                  &nbsp;{i18n.t("settingBar.logout")}
                </MenuItem>
              </Menu>
            </b>
          ) : (
            <b>
              ...
              >
                ...
                <MenuItem onClick={(e) => this.handleClose(e, "/login")}>
                  <AccountCircleIcon />
                  &nbsp;{i18n.t("settingBar.login")}
                </MenuItem>
                <MenuItem onClick={(e) => this.handleClose(e, "/signup")}>
                  <PersonAddIcon />
                  &nbsp;{i18n.t("settingBar.signup")}
                </MenuItem>
              </Menu>
            </b>
          )
  ...
  render() {
    return (
      <div style={{ transform: "translateY(10px)" }}>
        ...
        <div
          style={{ display: "flex", flexWrap: "nowrap", marginRight: "100px" }}
        >
          <div style={{ zIndex: 3 }}>
            ...
            <span>&nbsp;&nbsp;&nbsp;</span>
            <small className={styles.remark}>{i18n.t("header.subtitle")}</small>
          </div>
